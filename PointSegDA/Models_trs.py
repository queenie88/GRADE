...
class shared_layers_trs(nn.Module):
    def __init__(self, args, in_size=3):
        super(shared_layers_trs, self).__init__()
        self.args = args
        self.k = K
...
class shared_layers_trs2(nn.Module):
    def __init__(self, args, in_size=3):
        super(shared_layers_trs2, self).__init__()
        self.args = args
        self.k = K
    ...
    def forward(self, x):
        ...
        x123 = torch.cat((x_sa1, x_sa2, x_sa3), dim=1)
        x4 = self.conv6(x123)
...
class DGCNN_DefRec_tr(nn.Module):
    def __init__(self, args, in_size=3, num_classes=8):
        super(DGCNN_DefRec_tr, self).__init__()

        self.args = args
        self.k = K

        self.input_transform_net = transform_net(args, in_size*2, in_size)
        self.shared_layers = shared_layers_trs(args, in_size=in_size)
...
class DGCNN_DefRec_tr2(nn.Module):
    def __init__(self, args, in_size=3, num_classes=8):
        super(DGCNN_DefRec_tr2, self).__init__()

        self.args = args
        self.k = K

        self.input_transform_net = transform_net(args, in_size*2, in_size)
        self.shared_layers = shared_layers_trs2(args, in_size=in_size)
